...
public class CustomerDto {
	...
	public CustomerDto(int id, String name, String gender, String country, int allocated_room_no, String check_in_time,
			double deposit) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "CustomerDto [id=" + id + ", name=" + name + ", gender=" + gender + ", country=" + country
